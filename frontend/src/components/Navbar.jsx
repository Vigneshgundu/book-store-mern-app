    ...
    <header className="max-w-screen-2xl mx-auto px-4 py-6">
        <nav className="flex justify-between items-center">
            ...
            <div className="flex items-center md:gap-16 gap-4"> 
                <Link to="/">
                <PiChartBarFill className="size-6"/>
                </Link>
            ...
            <div className="relative flex items-center md:space-x-3 space-x-2">
                <div>
                    ...
                    <button onClick={()=>setisDropdownopen(!isDropdownOpen)}>
                        <img src={AvatarImg} alt="register" className={`size-7 rounded-full ${currentUser ? 'ring-2 ring-blue-500':""}`}/>
                    </button>
                        ...
                        isDropdownOpen && (
                            <div className='absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-md z-40'>
                                <ul className='py-2'>
                                    ...
                                    <li>
                                        <button onClick={handleLogout} className='block px-4 py-2 text-sm hover'>Logout</button>
                                    </li>
                                </ul>
                            </div>
                        )
                ...
                <button>
                    <IoIosHeart className="hidden sm:block"/>
                </button>    
